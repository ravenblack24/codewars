...
Test.assertDeepEquals(findOddNames(list1), findOddNamesSolution(list1));

console.log('List of developers: ', JSON.stringify(list2));
Test.assertDeepEquals(findOddNames(list2), findOddNamesSolution(list2));

console.log('List of developers: ', JSON.stringify(list3));
Test.assertDeepEquals(findOddNames(list3), findOddNamesSolution(list3));
*/
